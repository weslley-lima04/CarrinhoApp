...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        itens.add(new Produto("1","Água", "Água sem gás", "2.50", "bebida", R.drawable.agua));
        itens.add(new Produto("2","Bolo", "Chocolate", "6.00", "bebida" ,R.drawable.bolo));
        itens.add(new Produto("3", "Refrigerante", "Coca Cola", "5.00", "bebida" ,R.drawable.refri));
        itens.add(new Produto("4", "Salada", "Alface e tomate", "7.00", "bebida" ,R.drawable.salada));
        itens.add(new Produto("5", "Suco", "Laranja", "5.00","bebida", R.drawable.suco));
